...
Updated: 5/29/2017 
Minor modifications made by Frank Aylward in May 2021 <faylward@vt.edu>
"""

# USAGE: python get_ARSC.py <input directory of protein files> <outputfile>
# The input directory should contain FASTA files (*.faa file ending) with protein predictions. 
# If you use this code in a publication please cite: Mende et al., Nature Microbiology, 2017 https://doi.org/10.1038/s41564-017-0008-3
